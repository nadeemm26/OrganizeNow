...
if (isset($_POST['reset'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $conn->query("UPDATE merchant SET reset_token='$token' WHERE email='$email'");

        $reset_link = "http://localhost:8080/OrganizeNow/Merchant/reset_password.php?token=$token";
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'makwananadeem3@gmail.com'; 
