...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2025 at 07:48 PM
...
(6, 'Birthday Party', 'decoration', 5000, 'this is birthday party', 'gandhinagar', '2025-02-02', 'uploads/1738268550_PSX_20220131_213531-01.jpeg', '2025-01-30 20:22:30', 14),
...
(7, 'nadeem enterprize new', 'decoration', 'no give', 'tigerking2323@gmail.com', '2147483647', 'tiger'),
(12, 'nadeem enterprize', 'venue', 'no give', 'nnnng@gmail.com', '2147483647', '12345'),
(13, 'booking game', 'other', 'i have many books', 'books@gmail.com', '1597538526', 'Book'),
(14, 'Karnavati ', 'decoration', 'no give data', 'shreejiroadlines0082@gmail.com', '5687158268', '$2y$10$JigU8jDIit2p1jip1JCTHeUgKjimfqc0OrbPrFlRGjM9fQA0i0jiG');
...
--
ALTER TABLE `events`
  ADD CONSTRAINT `events_ibfk_1` FOREIGN KEY (`merchant_id`) REFERENCES `merchant` (`id`);
